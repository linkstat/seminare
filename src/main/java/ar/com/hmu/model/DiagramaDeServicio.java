...
public class DiagramaDeServicio {
	...
	public DiagramaDeServicio(UUID id, LocalDateTime fechaInicio, LocalDateTime fechaFin, JornadaLaboral jornadaLaboral, Map<Empleado, List<JornadaLaboral>> planificaciones, Servicio servicio, EstadoTramite estado) {
		this.id = id;
	...
	public void setPlanificaciones(Map<Empleado, List<JornadaLaboral>> planificaciones) {
		this.planificaciones = planificaciones;
	}
	...
	public Map<Empleado, List<JornadaLaboral>> getPlanificaciones() {
