...
public class DatabaseConnectorStatus {
    ...
    public static final String FUNCTIONAL_ICON = "serverStatus_icon_green_ok.png";
    ...
    public static final String AUTH_PROBLEM_ICON = "serverStatus_icon_blue_question.png";
    ...
    public static final String DB_SERVICE_PROBLEM_ICON = "serverStatus_icon_orange_warning.png";
    ...
    public static final String UNREACHABLE_SERVER_ICON = "serverStatus_icon_red_error.png";
