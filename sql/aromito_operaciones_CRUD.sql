...
VALUES
    ...
    (UUID_TO_BIN(UUID()), 'Alicia', 'Vivas', 'avivas@hmu.com.ar', 27554567443, CURDATE(), 'FEMENINO', TRUE, (SELECT id FROM Domicilio ORDER BY RAND() LIMIT 1), 'Empleado', @initPass),
    ...
    (UUID_TO_BIN(UUID()), 'Mauricio Elio', 'Garay', 'mgaray@hmu.com.ar', 24574741745, CURDATE(), 'OTRO', TRUE, (SELECT id FROM Domicilio ORDER BY RAND() LIMIT 1), 'Empleado', @initPass),
